...
export const cliCommandCatalog: readonly CliCommandCatalogEntry[] = [
  ...
  { commandPath: ["chat"], policy: { bypassConfigGuard: true, networkProxy: "bypass" } },
  ...
  { commandPath: ["terminal"], policy: { bypassConfigGuard: true, networkProxy: "bypass" } },
  { commandPath: ["tui"], policy: { bypassConfigGuard: true, networkProxy: "bypass" } },
